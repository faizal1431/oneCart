...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            getCurrentUser()
            navigate("/")
            toast.success("User Login Successful") // ✅ now works
            
        } catch (error) {
            console.log(error)
            setLoading(false) // ✅ FIXED: added missing setLoading(false) in catch
            toast.error("User Login Failed") // ✅ now works
        }
    }
    ...
    const googlelogin = async () => {
        try {
            ...
            console.log(error)
            toast.error("Google Login Failed") // ✅ added error feedback
        }
    }
